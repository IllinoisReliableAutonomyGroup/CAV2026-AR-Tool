...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{figures/empty-run-pose}
    \includegraphics[width=0.45\textwidth]{figures/abstract_viz_000021.png}
    \caption{Left: nominal trajectory (blue) with pose tube (gray). Right: abstract image bounds for a cell near a gate.}
\end{figure}
